...
(library (akku metadata)
  ...
  (define main-package-name '"dagopoly-scm")
  (define main-package-version '"0.0.0-alpha.0")
  (define installed-libraries
    '((arew json) (arew json shims) (hashing crc)
      (hashing fixnums) (hashing hmac) (hashing md5)
      (hashing private common) (hashing private compat)
      (hashing sha-1) (hashing sha-2) (hashing xxhash)
      (micro dagopoly) (micro dagopoly-python) (micro fs)
      (micro stream) (private install sipp) (srfi :0)
      ...
      (srfi :115 regexp) (srfi :115 regexp boundary) (srfi :116)
      ...
      (srfi :146 mappings) (srfi :146 nieper rbtree)
      (srfi :15 fluid-let) (srfi :151)
      ...
      (srfi :219) (srfi :23) (srfi :23 error)
      (srfi :23 error tricks) (srfi :25)
  ...
  (define installed-assets
    '(((include "dagopoly-python.scm")
      ...
      ((include "json/body.scm")
        ("arew/json/body.scm")
        (arew json))
      ((include "stream.scm") ("micro/stream.scm") (micro stream))
